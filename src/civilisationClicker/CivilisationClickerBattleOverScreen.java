...
public class CivilisationClickerBattleOverScreen extends JPanel implements MouseListener{
	/**
	 * 
	 */
	...
	CivilisationClickerBattleOverScreen(List<CivilisationClickerUnit> attackerTroops, List<CivilisationClickerUnit> defenderTroops, int province, int attacker, int defender, boolean attackerVictor) {
...
interface BattleOverScreenListener {
	void battleOver(CivilisationClickerBattleOverScreen screen);
}
class BattleOverUnitPanel {
	CivilisationClickerUnit unit;
	JPanel mainPanel;
	...
	BattleOverUnitPanel(CivilisationClickerUnit unit) {
		this.unit = unit;
		createPanels();
	}
	void createPanels() {
