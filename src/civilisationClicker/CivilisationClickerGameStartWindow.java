...
public class CivilisationClickerGameStartWindow extends JPanel implements ActionListener{
	...
	CivilisationClickerGameStartWindow(int[] startProvince, String[] playerName) {
