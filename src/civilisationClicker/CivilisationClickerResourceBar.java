...
public class CivilisationClickerResourceBar implements MouseListener, MouseMotionListener, OrderListener, ActionListener{
	...
	CivilisationClickerResearchScreen researchScreen;
	CivilisationClickerEdictScreen edictScreen;
	CivilisationClickerArmyScreen armyScreen;
	List<CivilisationClickerOrderTroopsScreen> orderTroopsScreens = new ArrayList<CivilisationClickerOrderTroopsScreen>();
	CivilisationClickerResourceBar() {
		...
		createResourceBar();
		researchScreen = new CivilisationClickerResearchScreen();
		researchScreen.mainPanel.setBounds(0, 32, 473, 360);
		CivilisationClickerEdictScreen.createProvinceIcons();
		edictScreen = new CivilisationClickerEdictScreen();
		edictScreen.mainPanel.setBounds(0, 32, 473, 632);
		armyScreen = new CivilisationClickerArmyScreen();
		armyScreen.mainPanel.setBounds(CivilisationClickerArmyScreen.ARMYPANELSIZE);
	...
	void updateLabels() {
		...
		for (int i=0; i<CivilisationClickerDataBase.screenTypes.size(); i++)
			resourceLabel[i].setText(CivilisationClickerMathFunctions.withSuffix(country.points[i]));
	}
	void updateCostLabel(double cost) {
		for (int i=0; i<resourceCostLabel.length; i++) {
			...
			resourceCostLabel[i].setText("-" + CivilisationClickerMathFunctions.withSuffix(cost));
		}
	}
	void updateCostLabel(int label, double cost) {
		...
		resourceCostLabel[label].setText("-" + CivilisationClickerMathFunctions.withSuffix(cost));
	}
	...
	void provinceInvaded(int province) {
		CivilisationClickerOrderTroopsScreen troopsScreen = new CivilisationClickerOrderTroopsScreen(CivilisationMainClass.playerID, province, true);
	...
	void createResourceLabels() {
		initialiseArrays(CivilisationClickerDataBase.screenTypes.size());
		int i = 0;
	...
	@Override
	public void removeOrderScreen(CivilisationClickerOrderTroopsScreen screen) {
