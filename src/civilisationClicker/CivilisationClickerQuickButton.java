...
public class CivilisationClickerQuickButton implements MouseListener{
	...
	CivilisationClickerQuickButton() {
		initialiseArrays();
		createGraphics();
	...
	void initialiseArrays() {
		int a = CivilisationClickerDataBase.screenTypes.size();
	...
	public void mouseEntered(MouseEvent e) {
		if (e.getSource() == buttonPanel) {
			double points = CivilisationClickerMapScreen.getProvince(selectedProvince).developementList.get(selectedScreen).pointsPerClick;
	...
	public void mousePressed(MouseEvent e) {
		if (e.getSource() == buttonPanel) {
			CivilisationClickerMapScreen.provinceList.get(selectedProvince).developementList.get(selectedScreen).clickButton();
