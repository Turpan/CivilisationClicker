...
public class CivilisationClickerScreen implements MouseListener, ScrollListener{
	...
	CivilisationClickerBuildingGraphicBar[] buildingGraphicPanel;
	ScrollBar buildingScrollBar;
	public CivilisationClickerScreen(int ID, int province) {
		this.ID = ID;
		...
		leftPanel.bgImage = new ImageIcon(CivilisationClickerSuperScreen.leftBarStageImage[ID - 1][0]);
		...
		leftBorderPanel.bgImage = new ImageIcon(CivilisationClickerSuperScreen.borderPanelImage[ID - 1]);
		...
		rightBorderPanel.bgImage = new ImageIcon(CivilisationClickerSuperScreen.borderPanelImage[ID - 1]);
		...
		clickLabel = new JLabel(CivilisationClickerSuperScreen.clickImage[ID - 1]);
	...
	void updateLabels() {
		...
		CivilisationClickerProvinceDevelopement developement = CivilisationClickerDataBase.mapList.
				get(CivilisationClickerDataBase.chosenMap).provinceList.get(province).developementList.get(ID - 1);
		int b = (int) developement.pointsPerSecond();
		pointsLabel.setText(CivilisationClickerMathFunctions.withSuffix(a));
		pointsPerSecondLabel.setText(CivilisationClickerMathFunctions.withSuffix(b) + "\\s.");
		for (int i=0; i<developement.numberOfBuildings; i++) {
			buildingCountLabel[i].setText(CivilisationClickerMathFunctions.withSuffix(developement.buildingCount[i]));
			int c = (int) developement.buildingCost[i];
			buildingCostLabel[i].setText(CivilisationClickerMathFunctions.withSuffix(c));
			int number = 0;
		...
		leftPanel.bgImage = new ImageIcon(CivilisationClickerSuperScreen.leftBarStageImage[ID - 1][developement.currentStage-1]);
	}
	void clickButton() {
	...
	void playClickSound() {
		...
		switch (soundPlayed) {
		case 1:
			CivilisationClickerSuperScreen.clickSound1[ID - 1].setFramePosition(0);
			CivilisationClickerSuperScreen.clickSound1[ID - 1].start();
			break;
		case 2:
			CivilisationClickerSuperScreen.clickSound2[ID - 1].setFramePosition(0);
			CivilisationClickerSuperScreen.clickSound2[ID - 1].start();
			break;
		case 3:
			CivilisationClickerSuperScreen.clickSound3[ID - 1].setFramePosition(0);
			CivilisationClickerSuperScreen.clickSound3[ID - 1].start();
			break;
		default:
			CivilisationClickerSuperScreen.clickSound1[ID - 1].setFramePosition(0);
			CivilisationClickerSuperScreen.clickSound1[ID - 1].start();
	...
	void buyBuilding(int building) {
		int modifier = 0;
		switch (CivilisationClickerSuperScreen.selectedBuySellButton) {
		case 1:
			modifier = 1;
			break;
		case 2:
		...
		CivilisationMainClass.resourceBar.updateLabels();
		CivilisationClickerDataBase.mapList.get(CivilisationClickerDataBase.chosenMap).provinceList.get(province).developementList.get(ID - 1).buyBuilding(building, modifier);
		buildingGraphicPanel[building].addImage(modifier);
	}
	void showBuildingCost(int building) {
		int buyModifier = 0;
		int sellModifier = 0;
		int a = CivilisationClickerSuperScreen.buildingPointPool;
		switch (CivilisationClickerSuperScreen.selectedBuySellButton) {
		case 1:
			buyModifier = 1;
			break;
		...
		double buildingCost = CivilisationClickerDataBase.mapList.get(CivilisationClickerDataBase.chosenMap).provinceList.get(province).developementList.get(ID - 1).buildingCost[building];
		if (buyModifier != 0) {
			double totalCost = 0;
			double potentialBuildingCost = buildingCost;
			for (int i=0; i<buyModifier; i++) {
				totalCost += potentialBuildingCost;
				potentialBuildingCost = potentialBuildingCost * CivilisationClickerProvinceDevelopement.buildingScaleMultiplier;
			}
	...
	void createBuildingPanels() {
		...
		String screenType = CivilisationClickerDataBase.screenTypes.get(ID - 1);
		...
		buildingUIPanel[0].bgImage = new ImageIcon(CivilisationClickerSuperScreen.buildingUIBar[ID - 1]);
		...
		scrollWindowSize = 0;
		int numberOfBuildings = CivilisationClickerDataBase.buildingList.get(ID - 1).buildingList.size();
		int i = 0;
		for (CivilisationClickerBuilding building : CivilisationClickerDataBase.buildingList.get(ID - 1).buildingList) {
			...
			buildingUIPanel[i+1].bgImage = new ImageIcon(CivilisationClickerSuperScreen.buildingUIBar[ID - 1]);
			...
			buildingBuyPanel[i].bgImage = new ImageIcon(CivilisationClickerSuperScreen.buildingButtonImage[ID - 1]);
			...
			buildingVerticalUIBar[i].bgImage = new ImageIcon(CivilisationClickerSuperScreen.borderPanelImage[ID - 1]);
			...
			String[] icon = {CivilisationClickerDataBase.buildingList.get(ID - 1).buildingList.get(i).IconImageLocation};
			buildingGraphicPanel[i] = new CivilisationClickerBuildingGraphicBar(CivilisationClickerDataBase.buildingList.get(ID - 1).buildingList.get(i).BarImageLocation, icon);
			...
			buildingIconLabel[i] = new JLabel(new ImageIcon(CivilisationClickerDataBase.buildingList.get(ID - 1).buildingList.get(i).ImageLocation));
			buildingNameLabel[i] = new JLabel(CivilisationClickerDataBase.buildingList.get(ID - 1).buildingList.get(i).Name);
		...
		if (scrollWindowSize > (CivilisationMainClass.gameHeight - 100)) {
			...
			buildingUIPanel[numberOfBuildings + 1].bgImage = new ImageIcon(CivilisationClickerSuperScreen.buildingUIBar[ID - 1]);
	...
	void readBuildingData() {
		int numberOfBuildings = CivilisationClickerDataBase.buildingList.get(ID - 1).getListSize();
		initialiseData(numberOfBuildings);
	}
	@Override
	public void mouseClicked(MouseEvent e) {
		if (e.getSource() == buy1Label && CivilisationClickerSuperScreen.selectedBuySellButton != 1) {
			CivilisationMainClass.soundEngine.playClickSound();
			CivilisationClickerSuperScreen.selectedBuySellButton = 1;
			colourBuySellLabels();
			return;
		} else if (e.getSource() == buy10Label && CivilisationClickerSuperScreen.selectedBuySellButton != 2) {
			CivilisationMainClass.soundEngine.playClickSound();
			CivilisationClickerSuperScreen.selectedBuySellButton = 2;
			colourBuySellLabels();
			return;
		} else if (e.getSource() == buy100Label && CivilisationClickerSuperScreen.selectedBuySellButton != 3) {
			CivilisationMainClass.soundEngine.playClickSound();
			CivilisationClickerSuperScreen.selectedBuySellButton = 3;
			colourBuySellLabels();
			return;
		} else if (e.getSource() == sell1Label && CivilisationClickerSuperScreen.selectedBuySellButton != 4) {
			CivilisationMainClass.soundEngine.playClickSound();
			CivilisationClickerSuperScreen.selectedBuySellButton = 4;
			colourBuySellLabels();
			return;
		} else if (e.getSource() == sell10Label && CivilisationClickerSuperScreen.selectedBuySellButton != 5) {
			CivilisationMainClass.soundEngine.playClickSound();
			CivilisationClickerSuperScreen.selectedBuySellButton = 5;
			colourBuySellLabels();
			return;
		} else if (e.getSource() == sell100Label && CivilisationClickerSuperScreen.selectedBuySellButton != 6) {
			CivilisationMainClass.soundEngine.playClickSound();
			CivilisationClickerSuperScreen.selectedBuySellButton = 6;
			colourBuySellLabels();
			return;
		}
	...
	public void mousePressed(MouseEvent e) {
		if (e.getSource() == clickLabel) {
			buttonPressed = true;
			clickLabel.setIcon(CivilisationClickerSuperScreen.clickImagePressed[ID - 1]);
			clickButton();
		}
	}
	@Override
	public void mouseReleased(MouseEvent e) {
		if (buttonPressed = true) {
			buttonPressed = false;
			clickLabel.setIcon(CivilisationClickerSuperScreen.clickImage[ID - 1]);
		}
	}
	void initialiseData(int buildings) {
		...
		buildingGraphicPanel = new CivilisationClickerBuildingGraphicBar[a];
