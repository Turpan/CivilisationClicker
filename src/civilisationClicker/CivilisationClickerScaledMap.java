...
public class CivilisationClickerScaledMap extends ProvinceLoader{
	...
	public CivilisationClickerScaledMap(String map, String directory, int playerCount, Dimension viewSize) { 
	...
	public void loadProvinces() {
		...
		miniMapSize = CivilisationClickerMathFunctions.getScaledDimension(new Dimension(mapWidth, mapHeight), new Dimension(MAPCONTAINERWIDTH, MAPCONTAINERHEIGHT));
