...
public class CivilisationClickerProvinceSelector extends CivilisationClickerScaledMap implements ActionListener, ProvinceListener{
	...
	CivilisationClickerProvinceSelector(String mapName, String mapDirectory, int playerCount, Dimension viewSize, int map) {
		//this.mapName = mapName + "-selector";
		super(mapName, mapDirectory, playerCount, viewSize);
		setColorList(CivilisationClickerDataBase.mapList.get(map).provinceColors);
		loadProvinces();
