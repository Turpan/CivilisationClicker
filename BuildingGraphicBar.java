...
public class BuildingGraphicBar extends PaintedPanel{
	/**
	 * 
	 */
	...
	BuildingGraphicBar (String buildingBar, String[] buildingIcon) {
	...
	BuildingGraphicBar (String buildingBar, String[] buildingIcon, String imageStyle) {
		this.bgImage = new ImageIcon(buildingBar);
		this.buildingIcon = new ImageIcon[buildingIcon.length];
		for (int i=0; i<buildingIcon.length; i++) {
			this.buildingIcon[i] = new ImageIcon(buildingIcon[i]);
